...
#캐릭터(스프라이트) 불러오기
character=pygame.image.load("C:\\Users\\kal99\\Desktop\\PythonWorkspace\\pygame_basic\\character.png")
...
#적 enemy 캐릭터
enemy=pygame.image.load("C:\\Users\\kal99\\Desktop\\PythonWorkspace\\pygame_basic\\enemy.png")
enemy_size = enemy.get_rect().size #이미지 크기 구해옴
enemy_width = enemy_size[0] # 캐릭터의 가로 크기
enemy_height = enemy_size[1] # 캐릭터의 세로 크기
enemy_x_pos = screen_width/2 - enemy_width/2 # 화면 가로의 절반
...
while running:
    ...
    for event in pygame.event.get(): # 어떤 이벤트가 발생하였는가 ?
        ...
        if event.type == pygame.KEYUP: #키가 떼면 멈춤
